...
function App() {
  ...
  return (
    <>
      ...
      <div className="h-screen flex items-center justify-center bg-[#f5f1e9] text-[#1b1b1b] px-4">
        <div className="w-full max-w-md">
          <h1 className="logo-text mb-1 text-center">MONEA</h1>
          <p className="subtitle mb-6 text-center">control de gastos</p>
          ...
          <div className="bg-white rounded shadow mt-8 p-4 w-full text-left">
            <h2 className="subtitle mb-4 text-center">balance mensual</h2>
          ...
          <div className="mt-8 w-full bg-white rounded shadow p-4 text-left">
            <h2 className="subtitle mb-4 text-center">Gastos del mes</h2>
